...
export const ZonesAdmin=(mount,deps={})=>{
  const ui=el('section',{className:'main-card'},[
    ...
    el('div',{className:'form-row mt-2'},[
      el('div',{},[ el('label',{className:'label'},['Código (automático)']), el('input',{id:'zCode',className:'input',placeholder:'Se generará al crear',disabled:true}) ]),
  ...
  qs('#btnCreate',ui).addEventListener('click',async()=>{
    ...
    try{
      ...
      qs('#zName',ui).value=''; msg.textContent='Zona creada ✅'; setTimeout(()=> msg.textContent=' ',1200);
